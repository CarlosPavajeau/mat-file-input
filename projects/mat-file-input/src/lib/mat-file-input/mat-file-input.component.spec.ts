...
describe('MatFileInputComponent', () => {
  ...
  it('should recognize all errorstate changes', () => {
    ...
    component.ngControl = { control: { errors: null, touched: false } as any } as any;
    ...
    expect(component.errorState).toBeFalsy();
    expect(component.stateChanges.next).not.toHaveBeenCalled();
    component.ngControl = { control: { errors: [ 'some error' ], touched: true } as any } as any;
  ...
  it('should use input ErrorStateMatcher over provided', () => {
    ...
    fixture.detectChanges();
    expect(component.errorState).toBeFalsy();
    component.ngControl = { control: { errors: [ 'some error', 'another error' ] } as any } as any;
    expect(component.errorState).toBeFalsy();
